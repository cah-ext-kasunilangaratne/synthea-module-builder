...
import SaveModule from '../../components/menu/SaveModule'
...
import LoadingLogo from '../../images/synthea-animated-logo.svg';
import ProxiLogo from '../../images/proxi-logo.png';
import MinimizePanel from '../../images/minimize-panel.png';
import FullscreenButton from '../../images/fullscreen.png';
import InfoButton from '../../images/Info.png';
import StateButton from '../../images/state-button.png';
import StateListButton from '../../images/statelist.png';
import CodeButton from '../../images/code-button.png';
import AttributeButton from '../../images/attribute-button.png';
import RelatedButton from '../../images/related-button.png';
import WarningButton from '../../images/warning-button.png';
  ...
  renderNav = (props) => {
    return(
      <div className='Editor-top'>
        <img src={ProxiLogo} className='Editor-top-logo'/>
        {/* <img src={SyntheaLogo} className='Editor-top-logo'/> */}
        <div className='Editor-top-title'>Model Builder</div>
        <div className='Editor-top-open'>
          <button className='button-clear' onClick={this.newModule(Object.keys(this.props.modules)).bind(this, undefined)}>New Model</button>
          <button className='button-clear' onClick={this.props.showLoadModule}>Open Model</button>
          <button className='button-clear Editor-top-download' onClick={this.props.showDownload}>Download</button>
          <button className='button-clear Editor-top-save' onClick={this.props.showSaveModule}>Save Model</button>
        </div>
        <div>
          <h2 className='user'>{sessionStorage.getItem('user')}</h2>
